...
class _AdminOrderPreTransitSectionState extends State<AdminOrderPreTransitSection> {
  ...
  Widget build(BuildContext context) {
    ...
    if (st == TransactionRequestStatus.enPreparacion) {
      ...
      bloqueoTransito =
          'Falta la factura del importador a la tienda minorista (pestaña Pedidos del importador).';
    }
    ...
    return Column(
      ...
      children: [
        ...
        Text(
          'Factura del importador a la tienda minorista',
          style: TextStyle(
        ...
        if (!hasFacturaImportador)
          Padding(
            ...
            child: Text(
              'Sin factura del importador la tienda minorista aún no puede enviar comprobante.',
              style: TextStyle(
                fontSize: 11,
