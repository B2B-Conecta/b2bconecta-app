  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        if (!hideSectionTitle) ...[
          Text(
            'Valoración de la tienda minorista (post-entrega)',
            style: TextStyle(
              fontWeight: FontWeight.w800,
              fontSize: 13,
              color: AppColors.textPrimary,
        ...
        Container(
          ...
          child: at == null
              ? Column(
                  ...
                  children: [
                    Text(
                      'Sin valoración: la tienda minorista aún no envió calificación '
...
class _TransactionRequestImporterRatingAdminSectionState
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        Text(
          'Valoración del mayorista (a la tienda minorista)',
          style: TextStyle(
            fontWeight: FontWeight.w800,
            fontSize: 13,
            color: AppColors.textPrimary,
              ...
              : _error != null
                  ...
                  : Column(
                      ...
                      children: [
                        Text(
                          _hasRated
                              ? 'El mayorista ya registró su valoración a la tienda minorista.'
                              : 'Sin valoración: el mayorista aún no calificó a la tienda minorista.',
                          style: TextStyle(
                            fontSize: 12,
                            height: 1.35,
                            color: AppColors.textPrimary,
...
class TransactionRequestDocumentPreferenceAdminSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final String label = p != null && p.isNotEmpty
        ...
        : 'Pendiente: la tienda minorista aún no indicó nota de entrega o factura fiscal.';
      ...
      children: [
        ...
        if (usa) ...[
          if (fiscalBloque != null && fiscalBloque.isNotEmpty)
            ...
            Text(
              'Dirección fiscal de la tienda minorista aún no disponible en esta vista.',
              style: TextStyle(
                fontSize: bodySize,
...
class TransactionRequestLifecycleSection extends StatelessWidget {
              ...
              children: [
                if (r.status == TransactionRequestStatus.rechazado) ...[
                    ...
                    label: r.anuladoPorMotolink
                        ...
                        : (r.canceladoPorImportador
                            ...
                            : (r.canceladoPorAliado
                                ? 'Cancelado por la tienda minorista'
                  ...
                  Divider(
                      height: 16, thickness: 0.5, color: AppColors.borderSubtle),
                  _TimelineRow(
                    label: 'Factura importador a la tienda minorista',
  ...
  static String _entregadoTimeline(TransactionRequestModel r) {
    ...
    return '$d\nRecepción confirmada por la tienda minorista en su taller';
  }
  ...
  static String _transitoValue(TransactionRequestModel r) {
    ...
    return '$d\nEntrega estimada a la tienda minorista: $eta';
  }
