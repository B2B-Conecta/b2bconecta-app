...
abstract final class OrderPaymentFlowCopy {
  ...
  static const importadorVerificarPagoTitulo = 'Comprobante de la tienda minorista';
  ...
  static String morosoDetalleImportador(TransactionRequestModel r) {
    ...
    if (impPend && fletePend) {
      return 'Entregado con pagos pendientes: comprobante de la tienda minorista y pago del flete.';
    }
    if (fletePend) {
      return 'Entregado con pago del flete pendiente de su confirmación.';
    }
    if (!r.hasProveedorFactura) {
      return 'Entregado sin pago aprobado. Falta factura o comprobante de la tienda minorista.';
    }
    return 'Revise el comprobante de la tienda minorista en la sección de pago.';
  }
}
