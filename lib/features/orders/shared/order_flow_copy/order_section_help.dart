...
abstract final class OrderSectionHelp {
  static const aliadoKycCredit =
      'Use este expediente para evaluar solicitudes de crédito B2B con la tienda minorista.';
  ...
  static const adminPreTransit =
      'La factura la emite el importador. Tras registrarla, la tienda minorista puede declarar pago; '
  ...
  static const cicloEnvioPago =
      'El comprobante y su aprobación quedan en el expediente de pago de la tienda minorista; '
  ...
  static const puntoRecoleccion =
      ...
      'Se confirma cuando el pedido está listo y la tienda minorista definió el transporte.';
}
