...
abstract final class OrderSectionHelp {
  static const aliadoKycCredit =
      'Use este expediente para evaluar solicitudes de crédito B2B con el minorista.';
  ...
  static const chatPedido =
      'Desde que el pedido está pendiente, minorista e importador pueden escribir aquí '
  ...
  static const adminPreTransit =
      'La factura la emite el importador. Tras registrarla, el minorista puede declarar pago; '
  ...
  static const cicloEnvioPago =
      'El comprobante y su aprobación quedan en el expediente de pago del minorista; '
  ...
  static const puntoRecoleccion =
      ...
      'Se confirma cuando el pedido está listo y el minorista definió el transporte.';
}
