...
class ProfileService {
  ...
  static Future<void> upsertMyProfile({
    ...
    if (requestedRole == null) {
      throw ArgumentError(
        'Seleccione un rol válido (importador o tienda minorista) antes de guardar.',
      );
    }
  ...
  static String profileSaveErrorMessage(Object error) {
    ...
    if (error is PostgrestException) {
      ...
      if (code == '23502' && msg.contains('role')) {
        return 'No se pudo guardar el perfil. Vuelva a seleccionar Importador o Tienda minorista e intente de nuevo.';
      }
    }
