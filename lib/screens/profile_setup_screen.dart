      ...
      body: SafeArea(
        child: SingleChildScrollView(
          ...
          child: ProfileB2BForm(
            key: ValueKey<Object>(
              '${initial?.id ?? 'new'}_${initial?.businessName}_${initial?.rif}_${initial?.kycStatus}_${initial?.primerosPedidosContadoEntregados}_${initial?.estado}_${initial?.ciudad}_${initial?.direccion}',
            ),
            initial: initial,
            showCloseBar: false,
