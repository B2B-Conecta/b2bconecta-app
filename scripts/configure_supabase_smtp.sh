...
case "$TARGET" in
  staging|dev)
    ...
    URI_ALLOW_LIST="${STAGING_URI_ALLOW_LIST:-https://b2bconecta-app-git-dev-b2bconecta.vercel.app/*,https://www.b2bconecta.com.ve/*,http://localhost:3000/*,http://127.0.0.1:3000/*,ve.com.b2bconecta.app://auth-callback}"
    ;;
  production|main)
    PROJECT_REF="${PRODUCTION_PROJECT_REF:-fzugzjcwdzcwfxgviltw}"
    SITE_URL="${PRODUCTION_SITE_URL:-https://www.b2bconecta.com.ve}"
    URI_ALLOW_LIST="${PRODUCTION_URI_ALLOW_LIST:-https://www.b2bconecta.com.ve/*,https://b2bconecta-app-git-dev-b2bconecta.vercel.app/*,http://localhost:3000/*,http://127.0.0.1:3000/*,ve.com.b2bconecta.app://auth-callback}"
    ;;
  *)
