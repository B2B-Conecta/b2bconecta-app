-- En fase contado (primeros 3 entregas contado): no exigir cupo ni comparar exposición.
-- Tras completar la fase, aplica límite asignado por MotoLink (como antes).
...
begin
  ...
  -- Fase contado: solo regla de un pedido activo; cupo lo define MotoLink después de esta fase.
  if pc < 3 then
