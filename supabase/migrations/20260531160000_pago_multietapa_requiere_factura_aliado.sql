-- Pago multietapa (cualquier fase operativa) pero solo si ya existe factura MotoLink al aliado.
-- Alineado con la app: comprobante y revisión MotoLink son expediente del pedido, no pasos del cronograma de envío.
