-- Tras completar las 3 entregas en contado: permitir INSERT de pedidos sin credit_limit
-- (pago al contado). La validación de cupo solo aplica si el aliado tiene límite > 0.
