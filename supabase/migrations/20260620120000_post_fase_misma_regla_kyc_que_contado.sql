-- Tras la fase de 3 entregas, no exigir kyc_status = 'aprobado' para INSERT de pedidos.
-- Misma regla que en fase contado: RIF y domicilio; solo 'rechazado' bloquea. Cupo si lim > 0.
