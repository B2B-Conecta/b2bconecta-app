-- Desvincular líneas canceladas/rechazadas del carrito (auditoría en original_checkout_group_id).
-- Para entornos que ya aplicaron migraciones anteriores sin esta columna + lógica.
...
comment on column public.transaction_requests.original_checkout_group_id is
  'UUID del carrito previo (checkout_group_id) antes de desvincular la línea al cancelar o rechazar.';
