-- Owner local: el email seed también puede recibir is_owner al insertar
-- el perfil, si aún no hay propietario (mismo mecanismo que gimenopueyo).
...
begin
  if tg_op = 'INSERT' then
    ...
    v_is_seed_owner :=
      v_email in ('gimenopueyo@gmail.com', 'owner@motoconecta.seed')
      and not exists (
        select 1
