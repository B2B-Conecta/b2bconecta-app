...
**Fuente de verdad del schema:** los archivos en esta carpeta. Hoy hay **115** migraciones: la baseline MotoConecta y todo lo posterior (pedidos, KYC, comisiones, logística, referidos, etc.).
