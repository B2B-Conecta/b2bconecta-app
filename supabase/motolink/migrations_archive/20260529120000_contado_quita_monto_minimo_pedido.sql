-- Si ya se aplicó 20260528120000 con validación de USD 50, esta migración la elimina.
-- El "mínimo" en contado es solo datos de registro (RIF + domicilio), no monto de pedido.
