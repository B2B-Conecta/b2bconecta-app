#!/usr/bin/env python3
"""Regenera lib/gen/motolink_pro_logo_bytes.dart desde assets/logo_motolinkpro.png."""
import base64
import pathlib

root = pathlib.Path(__file__).resolve().parent.parent
png = root / "assets" / "logo_motolinkpro.png"
out = root / "lib" / "gen" / "motolink_pro_logo_bytes.dart"

b64 = base64.b64encode(png.read_bytes()).decode("ascii")
out.parent.mkdir(parents=True, exist_ok=True)
out.write_text(
    f"""// Bytes of assets/logo_motolinkpro.png (embedded for reliable display on web).
